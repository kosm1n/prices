...
class PricesControllerE2ETest {
    ...
    void givenARequestToGetPrices_whenApplicationDateIs2020_06_14_16_00_00AndProductIdIs_35455AndBrandIdIs_1_thenReturnAListOfPricesWithWithSize2() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/prices?applicationDate=2020-06-14T16:00:00&productId=35455&brandId=1").contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$[0].price").value("35.5"))
                .andExpect(jsonPath("$[0].curr").value("EUR"))
                .andExpect(jsonPath("$[1].id").value("475bdb8a-b42e-4790-b9c9-7bf3a2f9cd21"))
                .andExpect(jsonPath("$[1].brand_id").value("1"))
                .andExpect(jsonPath("$[1].start_date").value("2020-06-14T15:00:00"))
                .andExpect(jsonPath("$[1].end_date").value("2020-06-14T18:30:00"))
                .andExpect(jsonPath("$[1].price_list").value("2"))
    ...
    void givenARequestToGetPrices_whenApplicationDateIs2020_06_15_10_00_00AndProductIdIs_35455AndBrandIdIs_1_thenReturnAListOfPricesWithWithSize2() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/prices?applicationDate=2020-06-15T10:00:00&productId=35455&brandId=1").contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$[0].price").value("35.5"))
                .andExpect(jsonPath("$[0].curr").value("EUR"))
                .andExpect(jsonPath("$[1].id").value("568f29a8-f0c6-4899-862b-e659ec320897"))
                .andExpect(jsonPath("$[1].brand_id").value("1"))
                .andExpect(jsonPath("$[1].start_date").value("2020-06-15T00:00:00"))
                .andExpect(jsonPath("$[1].end_date").value("2020-06-15T11:00:00"))
                .andExpect(jsonPath("$[1].price_list").value("3"))
                .andExpect(jsonPath("$[1].product_id").value("35455"))
                .andExpect(jsonPath("$[1].priority").value("1"))
    ...
    void givenARequestToGetPrices_whenApplicationDateIs2020_06_16_21_00_00AndProductIdIs_35455AndBrandIdIs_1_thenReturnAListOfPricesWithWithSize2() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/prices?applicationDate=2020-06-16T21:00:00&productId=35455&brandId=1").contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$[0].price").value("35.5"))
                .andExpect(jsonPath("$[0].curr").value("EUR"))
                .andExpect(jsonPath("$[1].id").value("5bfe6227-456b-4722-ad18-f811c00803bf"))
                .andExpect(jsonPath("$[1].brand_id").value("1"))
                .andExpect(jsonPath("$[1].start_date").value("2020-06-15T16:00:00"))
                .andExpect(jsonPath("$[1].end_date").value("2020-12-31T23:59:59"))
                .andExpect(jsonPath("$[1].price_list").value("4"))
                .andExpect(jsonPath("$[1].product_id").value("35455"))
                .andExpect(jsonPath("$[1].priority").value("1"))
